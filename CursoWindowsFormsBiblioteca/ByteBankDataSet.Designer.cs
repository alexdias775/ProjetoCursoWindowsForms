...
namespace CursoWindowsFormsBiblioteca.ByteBankDataSetTableAdapters {
    ...
    public partial class CLIENTETableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CLIENTE] WHERE (([Id] = @Original_Id) AND ((@IsNull_JSON = 1 A" +
                "ND [JSON] IS NULL) OR ([JSON] = @Original_JSON)))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CLIENTE] SET [Id] = @Id, [JSON] = @JSON WHERE (([Id] = @Original_Id" +
                ") AND ((@IsNull_JSON = 1 AND [JSON] IS NULL) OR ([JSON] = @Original_JSON)));\r\nSE" +
                "LECT Id, JSON FROM CLIENTE WHERE (Id = @Id)";
