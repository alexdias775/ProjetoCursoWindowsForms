    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                C.ValidaClasse();
                C.ValidaComplemento();
                //C.IncluirFichario("Cliente");
                //C.IncluirFicharioSQL("Cliente");
                C.IncluirFicharioSQLREL();
                //C.IncluirFichario("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte07\\Fichario");
                ...
                //Fichario F = new Fichario("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte06\\Fichario");
                //if (F.status)
                //{
        ...
        private void abrirToolStripButton_Click(object sender, EventArgs e)
        {
           if(Txt_Codigo.Text == "")
            ...
            else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    //C = C.BuscarFicharioDB("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte07\\Fichario", Txt_Codigo.Text);
                    //C = C.BuscarFicharioDB("Cliente", Txt_Codigo.Text);
                    //C = C.BuscarFicharioSQL("Cliente", Txt_Codigo.Text);
                    ...
                    //    //Desserializar - passar de json para classe
                    //    //Serializar - passa de classe para json
                    //    EscreveFormulario(C);
                    //}
                    //else
                    //{
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //C.AlterarFichario("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte07\\Fichario");
                    MessageBox.Show("OK: Identificador incluido com sucesso", "ByteBank", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    AtualizaGrid();
        ...
        private void ApagatoolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    //C = C.BuscarFichario("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte07\\Fichario", Txt_Codigo.Text);
                    //C = C.BuscarFicharioDB("Cliente", Txt_Codigo.Text);
                    //C = C.BuscarFicharioSQL("Cliente", Txt_Codigo.Text);
                    C = C.BuscarFicharioSQLREL(Txt_Codigo.Text);
                    if (C == null)
                ...
                //    Fichario F = new Fichario("C:\\Users\\NSYS-CDS-0201\\Documents\\Projetos\\ProjCursoWindowsForms\\ProjParte06\\Fichario");
                //if (F.status)
                //{
                //    //var mensgagem = MessageBox.Show("Deseja realamente excluir esse cliente?", "ByteBank", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List = C.BuscarFicharioTodosSQLREL();
                //List = C.ListaFichario("C:\\Users\\alexd\\Documents\\Programação\\Alura\\WindowsFormsComCSharp\\ProjParte07\\Fichario");
                if  (List == null)
                {
                ...
                else
                {
                    ...
                    //}
                    Frm_Busca Fbusca = new Frm_Busca(List);
                    Fbusca.ShowDialog();
                    if (Fbusca.DialogResult == DialogResult.OK)
                    {
                        var idSelect = Fbusca.idSelect;
                        //C = C.BuscarFicharioSQL("Cliente", idSelect);
            ...
            try
            {
               ...
               // List<List<string>> List = new List<List<string>>();
                ...
                for (int i = 0; i <= List.Count -1; i++)
                {
                    ...
                    row.CreateCells(dataGridViewClientes);
        ...
        private void dataGridViewClientes_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                row = dataGridViewClientes.SelectedRows[0];
